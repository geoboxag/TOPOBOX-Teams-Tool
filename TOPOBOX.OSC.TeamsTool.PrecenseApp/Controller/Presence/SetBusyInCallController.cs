...
{
    internal sealed class SetBusyInCallController : IController
    {
        // DEBUG Command: --setPresence busyincall --userid {userid}

        /// <summary>
        /// Name of FunctionType
        /// Key: must be unique
        /// </summary>
        private const string FUNCTIONTYPE = "busyincall";
        ...
        public SetBusyInCallController(BatchRuntimeSettings batchRuntimeSettings)
        {
        ...
        public bool Execute()
        {
            ...
            setPrecense.SetBusy(runtimeSettings.UserID, true);
            return true;
        }
    }
}
